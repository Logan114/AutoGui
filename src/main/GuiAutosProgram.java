...
public class GuiAutosProgram extends javax.swing.JFrame {
    ...
    private int potkerekekSzama;
    private int sliderErtek;
    /**
     * Creates new form GuiAutosProgram
     */
    
    public GuiAutosProgram(boolean uzemanyag, boolean megy) {
        this.uzemanyag = uzemanyag;
        this.megy = megy;
        this.defekt = defekt;
        double sliderErtek = sldEsely.getValue();
        defekt = false;
        uzemanyag = true;
        megy=false;
        potkerekekSzama = (Integer) mumPotkerek.getValue();
    }
    ...
    private void initComponents() {
        ...
        chbDefekt.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chbDefektItemStateChanged(evt);
            }
        });
    ...
    private void btnGarazsbaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGarazsbaActionPerformed
        cmbAutok.addItem("Beállítások alapján");
    ...
    private void sldEselyMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sldEselyMouseReleased
       String s = "esély defektre:";
        s += sldEsely.getValue() + "%";
        double sliderErtek = sldEsely.getValue();
        double defektEsely = sliderErtek/100;
        System.out.println(defektEsely);
        jLabel4.setText(s);
        Auto auto = new Auto(uzemanyag, megy, potkerekekSzama);
        auto.megyEselyDefektre(defektEsely);
        if (megy && defektEsely>0.0){
            
            auto.defektetKap();
            rdbDefekt.setSelected(defekt);
        }
    ...
    private void gombraIndit() {
        txaAllapot.setText("Beinditva");
        int potkerekekSzama = (Integer) mumPotkerek.getValue();
        megy = true;
        uzemanyag = true;
        Auto auto = new Auto(uzemanyag,megy,potkerekekSzama);
        boolean vanUzemanyag = auto.isUzemanyag();
        auto.setBeinditva(true);
        chbBeinditva.setSelected(true);
        rdbUzema.setSelected(vanUzemanyag);
    ...
    private void chbDefektItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chbDefektItemStateChanged
        // TODO add your handling code here:
        Auto auto = new Auto(uzemanyag,megy,potkerekekSzama);
    }//GEN-LAST:event_chbDefektItemStateChanged
